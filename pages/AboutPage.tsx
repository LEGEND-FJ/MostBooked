...
const AboutPage: React.FC = () => {
  ...
  return (
    <main className="pt-32 bg-primary">
        ...
        >
          ...
          <div className="relative aspect-square">
            ...
            >
              ...
              />
              <div className="absolute -bottom-10 -left-10 w-48 h-48 bg-accent rounded-2xl flex items-center justify-center p-8 hidden md:flex shadow-2xl">
      ...
      {/* Values Section */}
      <section className="bg-secondary py-24 border-y border-ui/5">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            ...
            >
              ...
              <h3 className="text-ui font-heading text-2xl uppercase tracking-widest">{v.title}</h3>
              <p className="text-ui/50 font-body leading-relaxed">{v.text}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-ui font-hero text-6xl mb-4 uppercase">The Collective</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, idx) => (
              <motion.div 
                ...
                whileHover={{ y: -10 }}
                className="group relative overflow-hidden rounded-2xl bg-secondary aspect-[3/4]"
              >
      ...
      <section className="py-24 bg-accent/5">
        <div className="max-w-4xl mx-auto text-center px-6">
          <h2 className="text-ui font-hero text-4xl md:text-6xl mb-8 uppercase leading-none">JOIN THE MOSTBOOKED COLLECTIVE</h2>
          ...
          <button className="px-10 py-4 bg-accent text-white font-heading text-lg tracking-widest hover:bg-white hover:text-accent transition-all duration-500 rounded-lg">
            WORK WITH US
          </button>
        </div>
      </section>
