  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        <h1 className="font-hero text-5xl md:text-7xl mb-8 text-white tracking-wider">Terms & Services</h1>
        <p className="text-gray-400 mb-8 italic">Last updated: February 20, 2026</p>
        ...
        <div className="space-y-6 text-lg leading-relaxed font-body">
          ...
          <div className="pt-8 border-t border-white/10">
            <p className="font-semibold text-white">For questions, contact:</p>
            <a href="mailto:Visualsbyokarts@gmail.com" className="text-accent hover:text-accent-hover transition-colors">
              Visualsbyokarts@gmail.com
            </a>
          </div>
        </div>
      </div>
