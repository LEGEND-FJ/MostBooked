            ...
            <div className="grid grid-cols-1 gap-4">
              {SERVICES.map(s => (
                <button
                  ...
                  className={`p-6 rounded-2xl text-left transition-all duration-300 border ${formData.serviceId === s.id ? 'border-accent bg-accent/5' : 'border-ui/10 bg-secondary/50 hover:bg-secondary'}`}
                >
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-xl font-heading text-ui">{s.title}</h3>
                      <p className="text-ui/40 text-sm">{s.price}</p>
                    </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {['09:00', '11:00', '13:00', '15:00', '17:00', '19:00'].map(t => (
                  <button
                    ...
                    className={`py-3 rounded-lg border transition-all ${formData.time === t ? 'bg-accent border-accent text-white' : 'bg-secondary border-ui/10 text-ui/60'}`}
                  >
                    {t}
                  </button>
                ))}
